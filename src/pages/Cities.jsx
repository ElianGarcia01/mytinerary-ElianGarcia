  ...
  return (
    <>
      ...
      <section className="h-[60vh] font-stretch-normal bg-cover bg-center bg-[url('./assets/images/BannerCities.jpg')] relative">
        ...
        >
          <h2 className="text-white text-3xl lg:text-4xl font-bold">Cities</h2>

          <p className="text-white text-md lg:text-2xl italic">
      ...
      <section className="bg-gray-200 min-h-screen">
        <h2 className="text-center text-2xl lg:text-4xl font-bold pt-12 px-4 text-gray-800 tracking-wide flex items-center justify-center gap-3">
          Find Amazing Cities
          <FaTreeCity className="text-blue-600 animate-pulse" />
        </h2>
        <p className="text-center text-md lg:text-lg text-gray-600 mt-4 px-6">
