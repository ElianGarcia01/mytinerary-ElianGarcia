        ...
        <>
            ...
            <div className=" bg-[#fff1de]">
                ...
                <div className="min-h-screen flex flex-col-reverse justify-center items-center lg:max-h-screen lg:flex-row lg:justify-center lg:space-x-6 lg:items-center">
                    ...
                    {/* CARD */}
                    <div className="bg-[#ffe4bc] h-full w-96 p-8 rounded-xl flex flex-col justify-center space-y-14 mt-16 shadow-2xl">
                        <h4 className="text-[#2E4A38] text-center text-4xl font-bold">Find the perfect destination</h4>
