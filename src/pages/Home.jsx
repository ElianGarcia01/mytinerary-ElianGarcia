    ...
    <>
      ...
      <section className="h-screen w-full object-cover">
        ...
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center flex flex-col items-center space-y-12 sm:space-y-16">
          ...
          <p className="text-gray-200 text-lg sm:text-2xl md:text-2xl font-stretch-ultra-expanded max-w-xl mx-auto drop-shadow-md italic">
          ...
          <div className="flex flex-col-reverse md:flex-row-reverse justify-center items-center gap-4">
            <div className="flex flex-col gap-8 mt-8 text-center">
              <div className="bg-gray-200 rounded-lg p-6 shadow-xl transition">
                ...
                <p className="text-gray-600">
                  Explore the city of love with its rich culture and
              ...
              <div className="bg-gray-200 rounded-lg p-6 shadow-xl transition">
                ...
                <p className="text-gray-600">
                  Discover a perfect blend of modernity and tradition in Japan’s
                  capital.
                </p>
              </div>
              <div className="bg-gray-200 rounded-lg p-6 shadow-xl transition">
                ...
                <p className="text-gray-600">
                  Experience the city that never sleeps with its iconic skyline
                  and vibrant culture.
                </p>
              </div>
            </div>
            <div className="w-full max-w-[18rem] md:max-w-[24rem] flex justify-center items-center">
              <img
                src={Rowing}
                alt=""
                className="rounded-xl h-full w-72 object-center shadow-2xl"
              />
            </div>
          </div>
        </section>
